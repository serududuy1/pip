                ...
                <?php
                    ...
                    <div class="col-sm-6 col-md-3">
                        ...
                        <div class="img">
                            ...
                            No Kamar: <?php echo $room['room_no'] ?></b></div>
                            Untuk     <?php echo $room['room_people'] ?> Orang
                            <br> Price: Rp <?php echo format_rupiah($room['room_price']) ?>,00 <br>
                            <?php 
            ...
            <div class="content">
                    ...
                    <div class="col-sm-6 col-md-6">
                        <div class="block-flat">
                            ...
                            <?php echo format_rupiah($room['room_price']* (40/100)) ?>,00 </div>
                            <?php 
                            $roomtypes = mysqli_query($connect, "SELECT * FROM roomtype WHERE roomtype_id='$room[roomtype_id]'");
                            $roomtype      = mysqli_fetch_array($roomtypes);
                            ?> Tipe Kamar:
