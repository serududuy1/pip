                      ...
                      <tbody class="no-border-y">
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            $facilitys = mysqli_query($connect, "SELECT * FROM facility");
                            while ($facility = mysqli_fetch_array($facilitys)) { { ?>
                                <input required type="checkbox" class="" name="facility_id[]" value="<?php echo $facility['facility_id'] ?>" <?php if (isset($multiple_names_array) && in_array($facility['facility_id'], $multiple_names_array)) { ?> checked="checked" <?php } ?>> <?php echo $facility['facility_name'] ?><br>
                            <?php }
                            } ?>
                          </td>
                        </tr>
